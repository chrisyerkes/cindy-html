...
/**
 * Two Column Project Block Template.
 *
...
$class_name = 'grid project-grid project-grid-2-columns';
...
<div <?php echo $anchor; ?>class="<?php echo esc_attr($class_name); ?>" style="--bs-gap: 1.375rem">
	<?php if ($projects) : foreach ($projects as $post) : setup_postdata($post);
			...
			<div class="g-col-12 g-col-lg-6 project">
				<?php if ($img) : ?>
